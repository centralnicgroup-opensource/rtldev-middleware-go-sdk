...
require (
	...
	golang.org/x/net v0.29.0 // using this version to make it compatible with dnscontrol
	golang.org/x/text v0.18.0 // using this version to make it compatible with dnscontrol
)
