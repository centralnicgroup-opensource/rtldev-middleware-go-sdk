...
require (
	...
	golang.org/x/net v0.39.0 // using this version to make it compatible with dnscontrol
	golang.org/x/text v0.24.0 // using this version to make it compatible with dnscontrol
)
