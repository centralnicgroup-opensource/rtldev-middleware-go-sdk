...
require (
	...
	golang.org/x/net v0.33.0 // using this version to make it compatible with dnscontrol
	golang.org/x/text v0.21.0 // using this version to make it compatible with dnscontrol
)
