...
require (
	...
	golang.org/x/net v0.30.0 // using this version to make it compatible with dnscontrol
	golang.org/x/text v0.19.0 // using this version to make it compatible with dnscontrol
)
