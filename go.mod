...
require (
	...
	golang.org/x/net v0.40.0 // using this version to make it compatible with dnscontrol
	golang.org/x/text v0.26.0 // using this version to make it compatible with dnscontrol
)
